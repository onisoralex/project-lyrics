...
// Chord Object Test
  ...
  a += `${((new Chord(5, "B", "#", "m", 7, "sus2", "").getChordAsText() === "Cm7sus2") ? BasicTestingFunctions.testPass(2, "Chord Test") : BasicTestingFunctions.testFail(2, "Chord Test"))}`;
  ...
  a += `${((new Chord(5, "g", "", "", 0, "", "").getChordAsText() === "Gm") ? BasicTestingFunctions.testPass(6, "Chord Test") : BasicTestingFunctions.testFail(6, "Chord Test"))}`;
  ...
  a += `${((new Chord(5, "G#m7sus4/D").transpose(-3).getChordAsText() === "Fm7sus4/B") ? BasicTestingFunctions.testPass(15, "Chord Test") : BasicTestingFunctions.testFail(15, "Chord Test"))}`;
  a += `${((new Chord(5, "G#m7sus4/D").transpose(12).getChordAsText() === "G#m7sus4/D") ? BasicTestingFunctions.testPass(16, "Chord Test") : BasicTestingFunctions.testFail(16, "Chord Test"))}`;
  a += `${((new Chord(5, "G#m7sus4/D").transpose(3).getChordAsText() === "Bm7sus4/F") ? BasicTestingFunctions.testPass(17, "Chord Test") : BasicTestingFunctions.testFail(17, "Chord Test"))}`;
  a += `${((new Chord(5, "G#m7sus4/D").transpose(-9).getChordAsText() === "Bm7sus4/F") ? BasicTestingFunctions.testPass(18, "Chord Test") : BasicTestingFunctions.testFail(18, "Chord Test"))}`;
